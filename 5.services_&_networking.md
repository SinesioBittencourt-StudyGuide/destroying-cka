...
Pods need to coordinate how they comunicate with outside entities.
Containers in a Pod can communicate with each other using standard inter-process communications (SystemV, POSIX).
Inter-Pod container communication can be acomplished using IP.
